...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun mergeEntriesByTemplate(oldEntry: IpEntry, newEntry: IpEntry, template: TemplateEntry): IpEntry {
        ...
        return oldEntry.copy(
            name = if (replaceFields.has("name")) newEntry.name.ifBlank { oldEntry.name } else oldEntry.name,
            address = if (replaceFields.has("address")) newEntry.address.ifBlank { oldEntry.address } else oldEntry.address,
